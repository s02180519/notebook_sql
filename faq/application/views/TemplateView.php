        ...
        <div id="sidebar">
            <div class="side-box">
                ...
                <ul class="list">
                    ...
                    <li><a href="/AddContact">Add a new record</a> </li>
                    <li><a href="/ViewRecords">View all records</a></li>
                    <li><a href="/Search">Search a record</a></li>
                    <li><a href="/FaqModule">Frequently asked questions</a></li>
                </ul>
            </div>
        </div>
        <div id="content">
            <div class="box">
                <?php include 'faq/application/views/'.$content_view; ?>
                <!--
